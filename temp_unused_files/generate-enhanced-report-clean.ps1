...
<head>
    ...
    <title>VaxCare API Test Report - $((Get-Date).ToString('yyyy-MM-dd HH:mm:ss'))</title>
    <style>
        body {
...
<body>
    <div class="container">
        <div class="header">
            ...
            <p>Generated on $((Get-Date).ToString('MMMM dd, yyyy at HH:mm:ss'))</p>
        </div>
        ...
        <div class="summary">
            ...
            <p><strong>Execution Time:</strong> $((Get-Date).ToString())</p>
        </div>
...
$htmlContent += @"
        ...
        <div class="footer">
            <p>Generated by VaxCare API Test Suite | $((Get-Date).ToString('yyyy-MM-dd HH:mm:ss'))</p>
        </div>
    </div>
</body>
</html>
