#!/usr/bin/env python3
"""
Robust Microsoft Teams Notification Script
Handles URL errors and network issues gracefully
"""
...
def test_network_connectivity():
    ...
    safe_print("🌐 Testing network connectivity...")
...
def test_webhook_connectivity(webhook_url):
    """Test webhook URL connectivity with retries"""
    safe_print(f"🔗 Testing webhook connectivity...")
...
def send_teams_notification_robust(webhook_url, payload):
    """Send notification to Microsoft Teams with robust error handling"""
    safe_print("📤 Sending Teams notification with robust error handling...")
...
def main():
    parser = argparse.ArgumentParser(description='Send test results to Microsoft Teams (Robust Version)')
    ...
    safe_print("🚀 Microsoft Teams Test Notification (Robust Version)")
    safe_print("=" * 60)
    ...
    if args.test:
        ...
        if send_teams_notification_robust(webhook_url, test_payload):
    ...
    if send_teams_notification_robust(webhook_url, payload):
        safe_print("🎉 Teams notification sent successfully!")
    else:
